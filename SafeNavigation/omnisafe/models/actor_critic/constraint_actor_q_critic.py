...
from omnisafe.models.actor_critic.actor_q_critic import ActorQCritic, MOActorQCritic
from omnisafe.models.base import Critic
from omnisafe.models.critic.critic_builder import CriticBuilder, MOCriticBuilder
...
class ConstraintActorQCritic(ActorQCritic):
    ...
    def __init__(
        ...
        super().__init__(obs_space, act_space, model_cfgs, epochs, quantile)
