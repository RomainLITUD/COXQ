...
class WCSAC(SAC):
    ...
    def _update_cost_critic(
        ...
        with torch.no_grad():
            ...
            target_q_value_c = cost[:, None, None] + self._cfgs.algo_cfgs.gamma * (1 - done[:,None, None]) * next_quantiles_cost
    ...
    def _loss_pi(
        ...
        q_reward = torch.stack(q_reward, -1)
        q_reward = torch.amin(q_reward, -1)
        ...
        return (loss_r + lam * q_cost).mean() / (1 + lam), q_cost.mean(), 0
